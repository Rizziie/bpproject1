...
public class TTTGraphics extends JFrame {
    private static final long serialVersionUID = 1L; // to prevent serializable warnin
    ...
    public TTTGraphics() {
        ...
        JOptionPane.showMessageDialog(this,
                "Welcome to our non OO Graphical Tic-Tac-Toe!\n\n"
                        + "If you are X, you goes first.\n"
                        + "Click on any cell to start the move.\n"
        ...
        // Set up GUI components (rest of your constructor unchanged)
